...
/**
 * Represents a MainController containing database file paths and initializes
 * starting data.
 */
public class MainController {
    /** File path name of the admin database file to access. */
    public static final String FILEPATH_ADMIN = "moblima/db/admin.txt";
    /** File path name of the movie database file to access. */
    public static final String FILEPATH_MOVIE = "moblima/db/movie.txt";
    /** File path name of the holiday database file to access. */
    public static final String FILEPATH_HOLIDAY = "moblima/db/holiday.txt";
    /** File path name of the cineplex database file to access. */
    public static final String FILEPATH_CINEPLEX = "moblima/db/cineplex.txt";
    /** File path name of the cinema database file to access. */
    public static final String FILEPATH_CINEMA = "moblima/db/cinema.txt";
    /** File path name of the showing database file to access. */
    public static final String FILEPATH_SHOWING = "moblima/db/showing.txt";
    /** File path name of the price database file to access. */
    public static final String FILEPATH_PRICE = "moblima/db/price.txt";
    /** File path name of the booking database file to access. */
    ...
    /**
     * Creates starting data for admins, cineplexes and pricing if data is not
